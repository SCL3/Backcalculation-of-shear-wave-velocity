...
def train_model(seed, data_folder, in_instances, in_channels, model, model_name,
    ...
    train_dataset_raw = MyDataset(
        ...
        os.path.join(data_folder, 'input'), os.path.join(data_folder, 'output6'), # Adapted to Kinh 150K dataset
...
if __name__ == "__main__":
    ...
    data_folder = '300K_dataset_files/test/dataset'  # 300K data, model 6
    ...
    dataset = MyDataset(in_instances,
                        ...
                        output_dir=os.path.join(data_folder, 'output6'), # Adapted to Kinh 150K dataset
                        add_noise=False,
                        noise_std=0.00)
    sample = dataset[0]
