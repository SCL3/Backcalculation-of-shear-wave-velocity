...
if __name__ == "__main__":
    # -- Settings
    CSV_PATH = "log/90K_RMSELoss_No_Noise/log_all_models_v2.csv"  # path to the log file (relative to this script)
    ...
    OUTDIR = "figures/V2/90K_RMSELoss_No_Noise"   # output directory for the figures
    EXCLUDE_MODELS = [
