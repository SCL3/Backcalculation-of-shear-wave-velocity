...
if __name__ == "__main__":
    # -- Settings
    CSV_PATH = "log/300K_RMSELoss_No_Noise/log_300k_v1.csv"  # path to the log file (relative to this script)
    ...
    OUTDIR = "figures/300K/log_geo_model_v1"   # output directory for the figures
    EXCLUDE_MODELS = [
